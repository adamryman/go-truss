...
// Remove this function as it will no longer be needed.
func GenerateServiceInterface(sd *svcdef.Svcdef, conf gengokit.Config) (io.Reader, error) {
	const template = `
...
type {{.Service.Name}}Service interface {
	{{range $i := .Service.Methods -}}
		{{$i.Name}}(context.Context, *{{$i.RequestType.Name}}) (*{{$i.ResponseType.Name}}, error)
	{{end}}
}
	`
	...
	return data.ApplyTemplate(template, "interface.go")
}
