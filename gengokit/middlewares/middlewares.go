// Package middlewares renders the service and endpointe middleware files in NAME/middlewares/.
package middlewares
...
const EndpointsPath = "NAME/middlewares/endpoints.gotemplate"

// ServicePath is the path to the Service middleware file that package middlewares renders
const ServicePath = "NAME/middlewares/service.gotemplate"
